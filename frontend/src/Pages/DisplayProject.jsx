...
import { AlignLeft, Copy, ExternalLink, FileChartPie, UserPlus, Plus, FileText } from 'lucide-react';
      ...
      <div className="border border-2-black w-[70%] min-h-[100vh]">
        ...
        <div className="flex px-[80px] pt-3 gap-3">
          ...
          <label htmlFor="file-upload" className="cursor-pointer">
            ...
            <div className="flex h-[70px] w-[70px] border-2 rounded-lg border-gray-500 items-center justify-center">
              <Plus />
            </div>
          </label>
          ...
          <div className="flex h-[70px] w-[200px] border-2 rounded-lg border-gray-500 items-center pl-3">
            ...
            <div className="flex flex-col justify-start">
              <h6 className="font-semibold text-gray-800">Example.pdf</h6>
      ...
      <div className="border border-2-black w-[18%] min-h-[100vh] p-4">
        ...
        <div className="w-full flex items-center mt-[10px] ml-[10px] gap-3">
          <div className="h-[50px] w-[50px] bg-[#776aff] font-bold text-white text-xl rounded-full flex justify-center items-center">
            {projectData.createdby?.name?.charAt(0) || 'U'}
          </div>
        ...
        <div className="w-full flex items-center mt-[10px] ml-[10px] gap-[4px]">
          <div className="h-[44px] w-[44px] font-bold text-gray-600 text-xl rounded-full flex justify-center items-center outline outline-[4px] outline-dotted outline-gray-600 mr-[3px]">
            <UserPlus />
          </div>
